...
async function run() {
    ...
    // Scroll down inside the left container to show Negative Prompt and Audio Codes
    await page.evaluate(() => {
    ...
    const shot = path.join(ARTIFACT_DIR, 'verification_advanced_negative_prompt_and_codes.png');
    await page.screenshot({ path: shot });
    console.log(`✓ Screenshot saved: verification_advanced_negative_prompt_and_codes.png`);
