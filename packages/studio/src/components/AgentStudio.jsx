            ...
            {[
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-lg font-bold transition-all ${
                  activeTab === t.id
                    ? "bg-[#df9c43] text-black shadow-[0_0_12px_rgba(223,156,67,0.3)]"
        ...
        <div className="flex items-center gap-3">
          ...
          {activeTab === "agents" && (
            <button
              ...
              className="px-4 py-2 bg-[#df9c43] text-black font-bold text-xs rounded-xl hover:bg-[#e8aa55] transition-all shadow-glow flex items-center gap-1.5"
            >
              <span>+</span>
          ...
          {activeTab === "canvas" && (
            <button
              ...
              className="px-4 py-2 bg-[#df9c43] text-black font-bold text-xs rounded-xl hover:bg-[#e8aa55] transition-all shadow-glow flex items-center gap-1.5 disabled:opacity-50"
            >
              {canvasRunning ? (
                <>
                        ...
                        <div className="flex items-start justify-between gap-3 mb-3">
                          ...
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button
                              ...
                              className="p-1.5 rounded-lg bg-black/60 hover:bg-[#df9c43] text-white/70 hover:text-black transition-colors"
                            >
                ...
                <div className="mt-8 p-6 rounded-2xl bg-black/60 border border-[#df9c43]/30 flex flex-col md:flex-row items-start justify-between gap-6 animate-fade-in-up">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="px-4 py-2 bg-[#df9c43] text-black font-bold text-xs rounded-xl hover:bg-[#e8aa55] transition-colors shadow-glow"
                    >
                      Ouvrir Chat Dédié
                    </button>
                    <button
          ...
          <div className="bg-[#0e0b08] border border-[#df9c43]/30 rounded-2xl w-full max-w-xl p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <form onSubmit={handleSaveAgent} className="space-y-4 text-xs">
              ...
              <div className="pt-3 border-t border-white/10 flex items-center justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-[#df9c43] text-black font-bold rounded-xl hover:bg-[#e8aa55] shadow-glow"
                >
                  Enregistrer l'Agent
                </button>
              </div>
            ...
            <form onSubmit={handleImportSkill} className="space-y-4 text-xs">
              ...
              <div className="pt-3 border-t border-white/10 flex items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#df9c43] text-black font-bold rounded-xl hover:bg-[#e8aa55] shadow-glow flex items-center gap-2 disabled:opacity-50"
                >
                  {isImporting ? (
                    <>
