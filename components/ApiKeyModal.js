    ...
    <div className="min-h-screen bg-[#030303] flex items-center justify-center px-4 font-inter">
      <div className="w-full max-w-sm bg-[#0a0a0a]/40 backdrop-blur-xl border border-white/10 rounded-xl p-10 shadow-2xl">
        <div className="flex flex-col items-center text-center mb-10">
          <div className="w-14 h-14 bg-[#df9c43]/5 rounded-2xl flex items-center justify-center border border-[#df9c43]/10 mb-6 group hover:border-[#df9c43]/30 transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#df9c43" strokeWidth="1.5" className="group-hover:scale-110 transition-transform">
          ...
          <p className="text-white/40 text-[13px] leading-relaxed px-4">
            Môguô Puissant — Studio d'IA Générative Décentralisé
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/[0.03] rounded-md px-5 py-3 text-sm text-white placeholder:text-white/10 focus:outline-none focus:ring-1 focus:ring-[#df9c43]/30 focus:bg-white/[0.07] transition-all"
          ...
          <p className="text-center text-[12px] text-white/20 pt-2">
            Need a key?{' '}
            <a href="https://muapi.ai/access-keys" target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#df9c43] transition-colors font-medium">
              Get one free →
            </a>
          </p>
        </form>
